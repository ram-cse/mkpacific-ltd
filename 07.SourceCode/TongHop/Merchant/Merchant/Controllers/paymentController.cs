...
namespace Merchant.Controllers
{
    public class paymentController : Controller
    {
        ...
        //                TransactionLogViewModel.AddLog("Customer of Website: "+checkit.SingleOrDefault().Website.URL+" just go to the form to enter the Money Pacific to buy the product!", DateTime.Now);
        //                return View();
        //            }
        //            else
        ...
        //                    // nhan form trong truong hop nhap thong tin address
        ...
        //              //  TransactionLogViewModel.AddLog("", DateTime.Now);
        //                return View();
        //            }
        ...
        //                        do
        //                        {
        //                            buyid = MPHash.Hash10(DateTime.Now.ToLongTimeString()).Substring(0, 15).ToUpper();
        //                            flag = StoreDb.BuyCustomers.Where(m => m.BuyingId == buyid).Any();
        //                            if (!flag)
        //                            {
        //                                b.BuyingId = buyid;
        //                                b.Password = MPHash.GetPassWordMD5Hash(buyid);
        ...
        //                                Loi = e.Message;
        //                                return RedirectToAction("payerror", new { id = Loi });
        //                            }
        //                        }
        ...
        //                        var website = StoreDb.Websites.Single(o => o.Id == Script.WebsiteId);
        //                        var webmaster = StoreDb.Webmasters.Single(oo => oo.Id == website.WebmasterId);
        ...
        //                        TransactionLogViewModel.AddLog("Customer: " + buyid + " has just paid the product on " + website.URL + " of Webmaster: " + webmaster.Username + " successfully!", DateTime.Now);

        //                        return View();
        //                    }
        //                    else
        //                    {
        //                        TransactionLogViewModel.AddLog("Customer has just made the payment but unsucessfully!", DateTime.Now);
        //                        return RedirectToAction("payerror", new { id = pay.Message });
        //                    }
        //                }
        //                catch (Exception e)
        //                {
        ...
        //                        TransactionLogViewModel.AddLog("Customer: " + buyid + " of Webmaster: " + webmaster.Username + " has just paid successfully!", DateTime.Now);
