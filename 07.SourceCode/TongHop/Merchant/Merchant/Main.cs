...
namespace MoneyPacificService.Util
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="PaymentModel", Namespace="http://schemas.datacontract.org/2004/07/MoneyPacificService.Util")]
...
public interface IMain
{
    ...
    MoneyPacificService.Util.PaymentModel MakePayment(string[] LstCodeNumber, int Amount);
}
...
public partial class MainClient : System.ServiceModel.ClientBase<IMain>, IMain
{
    ...
    public MoneyPacificService.Util.PaymentModel MakePayment(string[] LstCodeNumber, int Amount)
    {
