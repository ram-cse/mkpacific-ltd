<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Store.Master" Inherits="System.Web.Mvc.ViewPage<F5_MoneyPacificSite.ViewModels.StoreManagerAskToBePartnerViewModel>" %>
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table>
            ...
            <tr>
                ...
                <th><%: Html.LabelFor(model => model.Town) %></th>
                <td>
            ...
            <tr>
                <th><%: Html.LabelFor(model => model.Address2) %></th>
                <td>
            ...
            <tr>
                <th><%: Html.LabelFor(model => model.Zip) %></th>
                <td>
            ...
            <tr>
                <th colspan=2><%: Html.LabelFor(model => model.WebSite) %></th>
                <td colspan=2>
