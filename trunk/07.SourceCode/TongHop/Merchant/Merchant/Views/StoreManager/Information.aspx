<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<MoneyPacificSite.ViewModels.StoreManagerInformationViewModel>" %>
...
--%>
                        ...
                        <th><%:Html.LabelFor(model => model.Manager.Area) %></th>
                        <td><%:Html.DisplayFor(model => model.Manager.Area)%></td>
