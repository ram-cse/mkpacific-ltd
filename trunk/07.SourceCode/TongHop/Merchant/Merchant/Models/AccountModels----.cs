...
namespace Merchant.Models
{
    ...
    public interface IMembershipService
    {
        ...
        MembershipCreateStatus pCreateUser(string Name, string Username, string Password, string Email, string Phone);
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public MembershipCreateStatus pCreateUser(string Name, string Username, string Password, string Email, string Phone)
        {
