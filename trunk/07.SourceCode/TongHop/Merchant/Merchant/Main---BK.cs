...
namespace MoneyPacificSrv.DTO
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="PaymentModel", Namespace="http://schemas.datacontract.org/2004/07/MoneyPacificSrv.DTO")]
...
public interface IMain
{
    ...
    MoneyPacificSrv.DTO.PaymentModel MakePayment(string[] LstCodeNumber, int Amount);
}
...
public partial class MainClient : System.ServiceModel.ClientBase<IMain>, IMain
{
    ...
    public MoneyPacificSrv.DTO.PaymentModel MakePayment(string[] LstCodeNumber, int Amount)
    {
