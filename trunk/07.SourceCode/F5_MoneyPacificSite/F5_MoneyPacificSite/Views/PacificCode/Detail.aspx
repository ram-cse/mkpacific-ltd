...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            <th><%: Html.LabelFor(model => model.LastTransaction)%></th>
            <td><%if (Model.LastTransaction != null)
                      String.Format("{0:g}", Model.LastTransaction);%></td>
        </tr>
        <tr>
            <th><%: Html.LabelFor(model => model.CustomerPhone)%></th>
            <td><%: Model.CustomerPhone %></td>
        </tr>
        <tr>
            <th><%: Html.LabelFor(model => model.InitialAmount)%></th>
            <td><%: Model.InitialAmount %></td>
        </tr>
        <tr>
            <th><%: Html.LabelFor(model => model.ActualAmount)%></th>
            <td><%: Model.ActualAmount %></td>
        </tr>
        <tr>
            <th><%: Html.LabelFor(model => model.CreateDate)%></th>
            <td><%: String.Format("{0:dd-MMM-yyyy}", Model.CreateDate)%></td>
        </tr>
        <tr>
            <th><%: Html.LabelFor(model => model.ExpireDate)%></th>
        ...
        <tr>
            <th><%: Html.LabelFor(model => model.StorePhone)%></th>
